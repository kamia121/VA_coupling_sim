...
export const PRESETS = [
  ...
  },
  {
    ...
    text: 'Concentric remodeling raises Ees and Ea together, so the ratio remains in the normal range; Kawaguchi reported an Ees of 4.7 mmHg/mL in HFpEF, compared with 2.1 to 3.3 mmHg/mL in controls. Relaxation is slow, with a fitted τ of 60 ms against 37 ms in the normal heart, and the EDPVR is steep. A 150-mL fluid bolus raises LAP by 2.5 mmHg here and by 1.9 mmHg in the normal heart, and removing the same volume lowers it by 2.5 mmHg.',
    refs: ['kawaguchi2003', 'borlaug2008'],
    detail: {
      mech: 'Concentric remodeling stiffens the ventricle in both systole and diastole. Ees and Ea increase in parallel, so Ea/Ees and EF remain normal <cite data-ref="kawaguchi2003"></cite>. Relaxation is prolonged, with a τ of 59 ± 14 ms in HFpEF against 35 ± 10 ms in controls <cite data-ref="zile2004"></cite>, and the EDPVR is steep, so a given filling volume requires a higher diastolic pressure and the ventricle depends more on atrial contraction to complete filling. In the model, loss of atrial contraction reduces stroke volume by 15% in this scenario and by 10% in the normal heart; setting the atrial contraction slider to zero in the simulator reproduces this loss. The baroreflex set point is moved to the prevailing pressure, a simplification of the partial resetting seen in chronic hypertension <cite data-ref="lohmeier2015"></cite>.',
  ...
  },
  {
    ...
    params: { svr: 0.29, cSys: 1.8, hr: 87, vStressed: 528 },
    text: 'SVR and Ea are low while Ees is normal, so Ea/Ees falls below the normal range and MAP is 64 mmHg despite a cardiac output of 9.4 L/min. The baroreflex has raised the heart rate to 112/min and recruited venous volume; with the reflex switched off, MAP would be 43 mmHg.',
    refs: ['guarracino2014', 'ikonomidis2019'],
    detail: {
      mech: 'Loss of arterial tone lowers SVR and Ea while Ees remains normal. Ea/Ees falls below the normal range together with MAP; ventricular function is preserved, and the arterial load is too low to sustain perfusion pressure. The baroreflex responds with tachycardia, a rise in Ees, and venoconstriction, which raise MAP from 43 to 64 mmHg.',
  ...
  },
  {
    ...
    detail: {
      ...
      see: 'Echo shows a low EF and a low single-beat Ees <cite data-ref="chen2001,guarracino2014"></cite>. MAP is borderline, and cardiac output, at 6.6 L/min, is well below the 9.4 L/min of the vasoplegia scenario at a similar heart rate (see tables).',
  ...
  },
  {
    ...
    text: 'SVR and arterial stiffness increase while Ees is unchanged. The Ea line steepens and the end-systolic point moves up the same ESPVR, so stroke volume falls by about 16%; the same relative change reduces stroke volume by about 26% in HFrEF. The baroreflex slows the heart to 60/min.',
  ...
  },
  {
    ...
    text: 'PVR is 11 WU, the RV Ees is 0.60 mmHg/mL, and the RV ESPVR is shifted to the right. Ees/Ea is 0.42, below the 0.805 threshold that Tello associated with the onset of RV failure, and SV/ESV is 0.31, below the 0.515 threshold reported by Vanderpool. The dilated RV raises RAP to 12 mmHg, displaces the septum toward the LV, and underfills the LV.',
    refs: ['tello2019hf', 'vanderpool2015', 'naeije2014'],
    detail: {
      mech: 'The RV has adapted heterometrically and dilates because its Ees no longer matches its Ea <cite data-ref="vonk2013,naeije2014"></cite>. Ees/Ea is below 0.805 <cite data-ref="tello2019hf"></cite>, and SV/ESV is below 0.515 <cite data-ref="vanderpool2015"></cite>. Dilation sustains stroke volume only at the cost of a high end-diastolic volume and RAP, and further filling moves the RV up an increasingly steep EDPVR. The raised RV diastolic pressure shifts the septum 15 mL toward the LV, which raises LV diastolic pressure at any given LV volume, and because the ventricles operate in series, the low RV output also underfills the LV.',
      ...
      manage: 'In acute RV failure, identification and treatment of the underlying cause is the primary strategy, together with judicious fluid management, inotropes and vasopressors, assist devices, and RV-protective ventilation <cite data-ref="harjola2016"></cite>. A rising CVP with a falling MAP calls for inotropic or vasoactive support, careful volume management, and inhaled pulmonary vasodilators <cite data-ref="lloyddonald2025"></cite>, although these interventions have not been well studied <cite data-ref="konstam2018"></cite>. In the simulator, a 150-mL fluid bolus raises RAP from 11.9 to 14.3 mmHg with almost no change in cardiac output. The inotrope raises cardiac output from 4.2 to 5.3 L/min and mPAP from 52 to 64 mmHg, and the pulmonary vasodilator raises cardiac output to 4.6 L/min while lowering mPAP and RAP. The arterial vasodilator lowers aortic pressure, and with it RV coronary perfusion, and the RV becomes ischemic; cardiac output falls to 2.5 L/min.',
  ...
  },
  {
    ...
    text: 'A normal RV is exposed to an acute PVR of 7.7 WU. Ees cannot rise acutely, so Ees/Ea falls to 0.53 and cardiac output to 4.3 L/min, while mPAP rises only to 37 mmHg. The hypertrophied RV of the compensated PAH scenario maintains a cardiac output of 5.1 L/min at a PVR of 7.3 WU.',
    refs: ['konstantinides2020', 'konstam2018', 'naeije2014'],
    detail: {
      mech: 'A normal, thin-walled RV cannot raise its Ees acutely. mPAP rises only moderately because an unadapted RV cannot generate more than its isovolumic pressure, Ees × (EDV − V₀), so the added load lowers flow more than it raises pressure. The dilating RV, constrained by the pericardium, shifts the septum 12 mL toward the LV. The baroreflex raises the heart rate to 80/min and holds MAP at 84 mmHg; with the reflex switched off, MAP is 67 mmHg.',
  ...
  // ---- Advanced scenarios: the mechanisms on the Advanced page change what these look like
  {
    ...
    text: 'An aortic valve area of 0.7 cm² produces a mean gradient of 55 mmHg and a peak gradient of 81 mmHg at a cardiac output of 5.3 L/min. The hypertrophied LV has a raised Ees, a steep EDPVR, and a τ of 53 ms, so LVEDP is 18 mmHg while LAP is 12 mmHg.',
    ...
    detail: {
      ...
      see: 'A mean gradient of 40 mmHg or more, a peak velocity of 4 m/s or more, or a valve area below 1.0 cm² grade the stenosis as severe <cite data-ref="baumgartner2017"></cite>. The gradient depends on flow. In the simulator, the inotrope raises cardiac output from 5.3 to 6.4 L/min and the mean gradient from 55 to 71 mmHg while the orifice area stays at 0.7 cm², which is why a low-flow state can hide severe stenosis behind a modest gradient.',
  ...
  },
  {
    ...
    text: 'An effective regurgitant orifice of 0.5 cm² opens into a normal-sized, noncompliant LA. The LV ejects 124 mL per beat, but only 58 mL reaches the aorta, a regurgitant fraction of 53%. Mean LAP is 14 mmHg with v waves reaching 21 mmHg, and Ea/Ees falls to 0.23 because the LA offers a low-impedance outlet.',
    refs: ['zoghbi2017'],
    detail: {
      ...
      manage: 'Afterload reduction redirects flow toward the aorta. In the simulator, the arterial vasodilator raises forward stroke volume from 58 to 65 mL and cardiac output from 4.6 to 5.5 L/min and lowers the regurgitant fraction from 53% to 49%, while MAP falls from 85 to 77 mmHg.',
  ...
  },
  {
    ...
    text: 'An effective regurgitant orifice of 0.3 cm² returns 44% of the stroke volume to the LV in diastole. The dilated, compliant LV ejects 135 mL per beat to deliver a forward stroke volume of 76 mL, and blood pressure is 132/46 mmHg.',
    refs: ['zoghbi2017'],
    detail: {
      ...
      manage: 'A faster heart rate shortens diastole, and with it the time available for regurgitation. In the simulator, raising the intrinsic heart rate from 70 to 90/min lowers the regurgitant fraction from 44% to 41% and LVEDP from 17 to 14 mmHg and raises the diastolic pressure from 46 to 56 mmHg.',
  ...
  },
  {
    ...
    detail: {
      ...
      manage: 'Slowing the heart rate lengthens diastole and allows relaxation to complete. In the simulator, lowering the intrinsic heart rate back to 70/min returns stroke volume to 71 mL.',
  ...
  },
  {
    ...
    text: 'An effective regurgitant orifice of 0.9 cm² returns 43% of the RV stroke volume, 56 mL per beat, to the RA. RAP is 12 mmHg with systolic RA waves reaching 17 mmHg, and the dilated RV, with an end-diastolic volume of 223 mL, displaces the septum 12 mL toward the LV.',
    refs: ['zoghbi2017'],
    detail: {
      ...
      manage: 'In the simulator, removing 150 mL of volume lowers RAP from 11.9 to 10.0 mmHg with a small fall in cardiac output, from 5.1 to 5.0 L/min.',
  ...
  },
  {
    ...
    detail: {
      ...
      see: 'Echo shows a severely dilated, hypokinetic RV and a septum displaced 17 mL toward an underfilled LV. mPAP is only 24 mmHg, lower than in the less severe PE scenario, because the failing RV cannot generate pressure.',
      manage: 'Norepinephrine raises aortic pressure and with it RV perfusion pressure. In the simulator, it restores RV contractility, raises MAP from 49 to 88 mmHg and cardiac output from 1.9 to 3.5 L/min, and mPAP rises to 44 mmHg as the RV recovers. The inotrope does not reverse the ischemia, because it raises demand and heart rate without restoring perfusion pressure, and a fluid bolus raises RAP to 15 mmHg without improving output. The pulmonary vasodilator also reverses it by lowering the load. The management of PE follows the ESC 2019 guideline <cite data-ref="konstantinides2020"></cite>.',

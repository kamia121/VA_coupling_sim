...
export const PRESETS = [
  ...
  },
  {
    ...
    text: 'Concentric remodeling raises ventricular Ees while arterial stiffening raises Ea, so the ratio stays near the resting reference even though both elastances are high; Kawaguchi reported an Ees of 4.7 mmHg/mL in HFpEF, compared with 2.1 to 3.3 mmHg/mL in controls. Relaxation is slow, with a fitted τ of 59 ms against 36 ms in the normal heart, and the EDPVR is steep. Adding 150 mL to modeled stressed blood volume raises LAP by 2.5 mmHg here and by 2.0 mmHg in the normal heart, and removing the same volume lowers it by 2.5 mmHg.',
  ...
  },
  {
    ...
    detail: {
      mech: 'A reduced Ees and a rightward-shifted ESPVR (V₀ of 40 mL in this scenario) leave a large end-systolic volume, and neurohormonal activation increases Ea. Ea/Ees is therefore well above the resting reference, EF is low, and SW/PVA is reduced <cite data-ref="burkhoff1986"></cite>. Because the ESPVR is flat, a small change in Ea moves the end-systolic point a long way along the volume axis, which the afterload handle on the dashed line of the simulator shows directly. The failing myocardium also loses the positive force–frequency relation <cite data-ref="hasenfuss1994"></cite>, so Ees does not rise with heart rate in this scenario.',
  ...
  },
  {
    ...
    text: 'SVR and Ea are low while Ees is normal, so Ea/Ees falls below the resting reference and MAP is 64 mmHg despite a cardiac output of 8.2 L/min. The baroreflex has raised the heart rate to 112/min and recruited venous volume; with the reflex switched off, MAP would be 46 mmHg.',
    refs: ['guarracino2014', 'ikonomidis2019'],
    detail: {
      mech: 'Loss of arterial tone lowers SVR and Ea while Ees remains normal. Ea/Ees falls below the resting reference together with MAP; ventricular function is preserved, and the arterial load is too low to sustain perfusion pressure. The baroreflex responds with tachycardia, a rise in Ees, and venoconstriction, which raise MAP from 46 to 64 mmHg.',
  ...
  },
  {
    ...
    detail: {
      ...
      manage: 'In acute RV failure, identification and treatment of the underlying cause is the primary strategy, together with judicious fluid management, inotropes and vasopressors, assist devices, and RV-protective ventilation <cite data-ref="harjola2016"></cite>. A rising CVP with a falling MAP calls for inotropic or vasoactive support, careful volume management, and inhaled pulmonary vasodilators <cite data-ref="lloyddonald2025"></cite>, although these interventions have not been well studied <cite data-ref="konstam2018"></cite>. In the simulator, the 150-mL modeled stressed-volume step raises RAP from 11.6 to 14.0 mmHg with almost no change in cardiac output. The inotrope raises cardiac output from 4.3 to 5.4 L/min and mPAP from 53 to 65 mmHg, and the pulmonary vasodilator raises cardiac output to 4.7 L/min while lowering mPAP and RAP. The arterial vasodilator lowers aortic pressure, and with it RV coronary perfusion, and the RV becomes ischemic; cardiac output falls to 2.7 L/min.',
  ...
  },
  {
    ...
    detail: {
      ...
      manage: 'Management focuses on the underlying left heart disease. PAH drugs are not established treatment for group 2 PH. For HFpEF with combined post- and pre-capillary PH specifically, the 2022 ESC/ERS guideline makes no general recommendation for or against PDE5 inhibitors; it recommends against them in HFpEF with isolated post-capillary PH <cite data-ref="humbert2022"></cite>.',
      note: '',
    },
  },
  ...
  },
  {
    ...
    detail: {
      ...
      manage: 'In the simulator, removing 150 mL of modeled stressed volume lowers RAP from 11.9 to 10.1 mmHg with a small fall in cardiac output, from 5.2 to 5.0 L/min.',
  ...
  },
  {
    ...
    detail: {
      ...
      manage: 'Drainage removes the constraint. In the simulator, the pericardial fluid slider shows the steep part of the relation: 100 mL raises pericardial pressure to 3 mmHg with a cardiac output of 4.9 L/min, and 230 mL raises it to 9 mmHg with a cardiac output of 3.1 L/min. The 150-mL modeled stressed-volume step raises RAP to 13 mmHg and cardiac output by only 3%.',
